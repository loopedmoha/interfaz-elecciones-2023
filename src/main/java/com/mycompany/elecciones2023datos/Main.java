...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        TablaCartones.setCellSelectionEnabled(true);
        TablaFaldones.setCellSelectionEnabled(true);
        tablaComunidades.setCellSelectionEnabled(true);
        tablaDatos.setCellSelectionEnabled(true);
        tablaMunicipios.setCellSelectionEnabled(true);
